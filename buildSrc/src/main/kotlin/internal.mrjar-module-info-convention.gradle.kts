...
// This convention plugin adds compilation of module-info.java with Java 9, which transforms output into a multi-release
// JAR for supporting Java Platform Module System if used by Java 9+.
